...
tab1, tab2, tab3, tab4 = st.tabs(
    ["일별 관객수 추이", "개별 누적 관객수", "TOP 5 비교", "전체 관객수 이동평균"]
)
...
with tab4:
    ...
    # 1. 기준일자별로 모든 TOP 10 영화의 '해당일관객수' 합계를 구합니다.
    daily_total = (
    ...
    # 3. Plotly Graph Objects를 사용하여 원본 선과 이동평균 선을 중첩해 그립니다.
    fig4 = go.Figure()

    # (1) 일일 관객수 합계 원본 선 (연하게 표시)
    fig4.add_trace(
        go.Scatter(
            x=daily_total["기준일자"],
